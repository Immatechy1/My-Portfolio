...
function BackgroundCircles({}: Props) {
  return (
    <motion.div
      ...
      className='relative flex justify-center items-center mt-96 sm:mt-96 md:mt-44 xl:mt-96'>
      ...
      <div className="rounded-full border border-[#ebc87d] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
