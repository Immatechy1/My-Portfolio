...
function ContactMe({ socials }: Props)  {
    ...
    const handleSendMessage = async ()=>{
       ...
       return (
        <div  className='bg-slate-950 text-white pt-[4rem]  pb-[3rem] '>
            ...
            <div data-aos="zoom-in-down" className='text-[2.8rem] text-center p-4 ml-[2rem]   text-white text-[2rem] font-semibold tracking-tighter'>
                Contact Me
                <div className='text-[#d44be0] mt-[-0.5rem] tracking-normal text-[1.1rem]'>get in touch with me</div>
            </div>
            ...
            <div className='md:flex grid grid-cols-2 md:flex-col gap-4'>
                <div data-aos="flip-right" className='pl-[1rem] pr-[1rem] pl-[2rem] max-w-[17rem] pr-[2rem] h-[9.3rem]  flex flex-col gap-4 items-center justify-center bg-[#1d1836]'>
                    <div><Image src='/images/mylocation.png' alt='address' width={40} height={40}/></div>
                    <div className='text-center text-[0.96rem] '>Remote</div>
                </div>
                <div data-aos="flip-right" className='pl-[1rem] pr-[1rem] pl-[2rem] break-words max-w-[17rem] pr-[2rem] h-[9.3rem]  flex flex-col gap-4 items-center justify-center bg-[#1d1836]'>
            ...
            <div data-aos="slide-up" className='flex flex-col items-center gap-4 md:gap-[3rem] md:pt-[3rem] h-[100%] w-[100%] md:w-[70%] max-w-[35rem] bg-[#1d1836] p-[1.1rem] p-[2rem] '>
                <div className='flex flex-row w-[100%] gap-[1rem] flex-row'>
                    <input className='text-[1rem] p-[0.8rem] w-[100%] w-[50%] bg-slate-950 outline-none focus:outline-none' type="text" placeholder='Enter your name'
                        value={name}
                        onChange={(e)=>{
                            setName(e.target.value)
                        }}
                    />
                    <input className='text-[1rem] p-[0.8rem] w-[100%] w-[50%] bg-slate-950 outline-none focus:outline-none' type="text" placeholder='Enter your email'
                        value={email}
                        onChange={(e)=>{
                ...
                <div className='h-[20rem] md:h-[24.52rem] w-[100%]  break-words'>
                    <textarea className='text-[1rem] p-[0.8rem] w-[100%] h-[100%] bg-slate-950 outline-none focus:outline-none' placeholder='Enter your message'
                        value={message}
                        onChange={(e)=>{
        ...
        <div className='mt-[5rem] flex flex-col gap-5 items-center justify-center'>
            <div className='text-[#d44be0] font-semibold text-lg'>Connect with me on social media</div>
