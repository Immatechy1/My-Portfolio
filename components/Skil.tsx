  ...
  return (
    <div className='group relative flex cursor-pointer'>
        <motion.img 
            ...
            className='rounded-full border border-gray-500 object-cover w-20 h-20 sm:w-16 sm:h-16 md:w-32 md:h-32 xl:w-32
            xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out' 
        />
        <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300
            ease-in-out group-hover:bg-white w-20 h-20 sm:w-16 sm:h-16 md:w-32 md:h-32 xl:w-32 xl:h-32
            rounded-full z-0'>
