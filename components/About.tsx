    ...
    <motion.div
      ...
      className='flex flex-col relative h-screen text-center md:text-left
        ...
        <motion.img 
            ...
            viewport={{once: true}}
            src="https://images.unsplash.com/photo-1664018106195-27d019de682f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8MXx8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=60"
